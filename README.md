...
To play with scenes presented in the paper, download the data [here](https://drive.google.com/drive/folders/1WVPcUas6c0rgjosLsdWDPf4c2RQL3U2y?usp=drive_link). Place the downloaded dataset according to the following directory structure:
```
